...
//using ITT.Shared.Shared.Validations.Helpers;
using Microsoft.AspNetCore.Mvc;
using Microsoft.OpenApi.Models;
using System.Globalization;
using ITT.DocumentUploadService.Infrastructure.Extensions;
using ITT.DocumentUploadService.Persistence.DataContext;
using Microsoft.EntityFrameworkCore;
using ITT.DocumentUploadService.Shared.Validations.Helpers;
using FluentValidation.AspNetCore;
using ITT.DocumentUploadService.Api.Extensions;
using ITT.DocumentUploadService.Shared.Common;
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Document Uploads v1.1"));
}
